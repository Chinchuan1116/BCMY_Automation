...
#         package (String)
#         activity (String)
# Output: capabilities (Dictionary)
#         url (String)
...
# Input:  capabilities (Dictionary)
#         url (String)
#         freeze (Integer)
# Output: driver (WebDriver)
#         wait (WebDriver)
...
# Output: cx [Center of x of element] (Integer)
#         cy [Center of y of element] (Integer)
#         width  (Integer)
#         height (Integer)
...
# Tap Gesture
# Input:  actions (ActionChains)
#         x [Position x-index to tap] (Integer)
#         y [Position y-index to tap] (Integer)
# Output: None
...
# Double Tap Gesture
# Input:  actions (ActionChains)
#         x [Position x-index to double tap] (Integer)
#         y [Position y-index to double tap] (Integer)
# Output: None
...
# Long Press Gesture
# Input:  actions (ActionChains)
#         x [Position x-index to long press] (Integer)
#         y [Position y-index to long press] (Integer)
# Output: None
...
# Input:  actions (ActionChains)
#         x1, y1 [Initial position x/y-index] (Integer)
#         x2, y2 [Final position x/y-index] (Integer)
# Output: None
